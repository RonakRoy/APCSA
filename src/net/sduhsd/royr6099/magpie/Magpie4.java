...
public class Magpie4 {
	...
	/**
	 * Take a statement with "I want <something>." and transform it into "Would
	 * you really be happy if you had <something>?"
	 * 
	 * @param statement
	 *            the user statement, assumed to contain "I want" but not "I
	 *            want to"
	 * @return the transformed statement
	 */
